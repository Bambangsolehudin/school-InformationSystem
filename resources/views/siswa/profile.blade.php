							...
							<div class="profile-left">
								...
								<div class="profile-header">
									...
									<div class="profile-main">
										<img src="{{$siswa->getAvatar()}}" class="img-circle img-thumbnail img-responsive" alt="Avatar">
								...
								<div class="profile-detail">
									...
									<div class="text-center"><a href="/siswa/{{$siswa->id}}/edit" class="btn btn-warning">Edit Siswa</a></div>
								</div>
		        ...
		        <form action="/siswa/{{$siswa->id}}/addnilai" method="post">
			        ...
			        <div class="form-group">
					  ...
					  <div class="form-group{{$errors->has('nilai') ? 'has->error' : ''}} ">
					    ...
					    <input type="text" class="form-control"  placeholder="Nilai" name="nilai" value="{{old('nilai')}}">

					    @if($errors->has('nilai'))
					    	<span class="help-block" style="color: red;">{{$errors->first('nilai')}}</span>
					    @endif
					  </div>
