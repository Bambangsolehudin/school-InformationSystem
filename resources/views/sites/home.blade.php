...
@section('content')
<!-- start banner Area -->
			<section class="banner-area relativ img-thumbnail" id="home" style="background: url('{{config('sekolah.image_banner')}}');">
				...
				<div class="container">
					<div class="row fullscreen d-flex align-items-center justify-content-between">
						<div class="banner-content col-lg-9 col-md-12">
							...
							<a href="#" class="primary-btn text-uppercase">{{config('sekolah.welcome_message_button_text')}}</a>
						</div>										
					</div>
				</div>					
			</section>
					...
					<div class="row">
						<div class="col-lg-4">
							<div class="single-feature">
								...
								<div class="desc-wrap">
									<p>
										{{config('sekolah.home_feature_colomn_1_content')}}
									</p>
									<a href="{{config('sekolah.home_feature_colomn_1_link_url')}}">{{config('sekolah.home_feature_colomn_1_link_text')}}</a>									
								</div>
							</div>
						</div>
						<div class="col-lg-4">
							<div class="single-feature">
								...
								<div class="desc-wrap">
									<p>
										{{config('sekolah.home_feature_colomn_2_Content')}}
									</p>
									<a href="{{config('sekolah.home_feature_colomn_2_link_url')}}">{{config('sekolah.home_feature_colomn_2_link_text')}}</a>									
								</div>
							</div>
						</div>
						<div class="col-lg-4">
							<div class="single-feature">
								...
								<div class="desc-wrap">
									<p>
										{{config('sekolah.home_feature_colomn_3_Content')}}
									</p>
									<a href="{{config('sekolah.home_feature_colomn_2_link_url')}}">{{config('sekolah.home_feature_colomn_3_link_text')}}</a>									
								</div>
							</div>
						</div>												
					</div>
